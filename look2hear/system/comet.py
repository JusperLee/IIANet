###
# Author: Kai Li
# Date: 2021-06-19 11:50:41
# LastEditors: Kai Li
# LastEditTime: 2021-06-20 01:20:15
###
...
class CometLogger(LightningLoggerBase):
    ...
    **OFFLINE MODE**
    ...
    @rank_zero_only
    def log_text(self, notion: str) -> None:
        self.experiment.log_text(notion)

    # @rank_zero_only
    # def log_graph(self, model) -> None:
    #     self.experiment.set_model_graph(str(model))

    @rank_zero_only
    def log_embedding(self, perm, label) -> None:
